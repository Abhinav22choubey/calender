...
export default function CalendarContainer() {
  ...
  return (
    <div className="w-full min-h-screen bg-neutral-200 flex justify-center items-start pt-16 relative overflow-x-hidden">
      {/* Wrapper (important for positioning scaling) */}
      <div className="relative w-[95%] max-w-5xl">
        {/* Spiral Image (RESPONSIVE + LOCKED POSITION) */}
        <img
          src={calendertop}
          alt="calendar-top"
          className="
        ...
        {/* Bottom Shadow */}
        <div className="absolute left-1/2 -translate-x-1/2 mt-4 w-[60%] h-6 bg-black/20 blur-2xl rounded-full"></div>
      </div>
    </div>
  );
}
